...
wget --no-check-certificate https://raw.githubusercontent.com/ldomb/ospdirectorinstaller/master/yamlconfigs/limits.yaml
...
wget --no-check-certificate https://raw.githubusercontent.com/ldomb/ospdirectorinstaller/master/yamlconfigs/firstboot-config.yaml
wget --no-check-certificate https://raw.githubusercontent.com/ldomb/ospdirectorinstaller/master/yamlconfigs/fix_rabbit.yaml
